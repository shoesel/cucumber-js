function Cli(argv) {
  ...
  function getProgram () {
    ...
    program
      ...
      .option('-P, --part <PARTNUMBER/COUNT>', 'Split up the tests into COUNT parts and run the PARTNUMBER part. This can be used to break up the test suite into segments for the purpose of parallelization.');
